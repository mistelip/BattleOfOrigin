...
public class WonderEnergyBehaviorDarwinist : MonoBehaviour {
	...
	void Awake () {
		...
		logoRectTransform = GameObject.Find ("DarwinistLogo").GetComponent<RectTransform> ();
		lifeTime = 0.0f;
		isLogoScaled = false;
	}
	...
	void FixedUpdate () {
		...
		var direction = new Vector3 (0.0f - screenPosition.x, Screen.height - screenPosition.y, 0.0f);
